...
We can compute the cartesian velocities by taking \eqref{eq::kine-displacements}
and using it to compute \(\vd{r}_s\)
\begin{equation}
...
\(\de\vd{r}_s\), taking special note of the one that also appears in \(\di\vd{r}_s\).
